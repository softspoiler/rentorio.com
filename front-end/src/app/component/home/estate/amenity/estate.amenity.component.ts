...
@Component({
  selector: 'estate-amenity',
  templateUrl: './estate.amenity.component.html',
  styleUrls: ['./estate.amenity.component.css', '../common.css']
})
export class EstateAmenityComponent implements OnInit {
